...
<script type="text/javascript">
	function addr_search(f) 
	{
		f.location.href="view/addr_search.jsp"
	}
</script>
</head>
<body>
	...
	<div>
		<div class="div_in">
			<form>
				<!-- 음식으로 검색하기 -->
				<input class="in" type="text" value="음식이름" name="food_search" required>
				<input class="btn" type="button" value="검색" onclick="food_search(this.form)">
			</form>
		</div>
		<div class="div_in">
			<form>
				<!-- 음식점으로 검색하기 -->
				<input class="in" type="text" value="가게이름" name="restaurant_search" required>
				<input class="btn" type="button" value="검색" onclick="restaurant_search(this.form)">
			</form>
		</div>
		<div>
			<fieldset>
