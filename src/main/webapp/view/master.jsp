					...
					<td colspan="3">
						...
						<c:choose>
							...
							<c:otherwise>
								<span style="color: tomato; padding: 5px; border: 1px solid tomato">
									<a class="btn" href="${pageContext.request.contextPath}/MyController?cmd=boardlist&cPage=${pvo.beginBlock-pvo.pagePerBlock}">이전으로</a>
								</span>
							</c:otherwise>
						</c:choose>
						&nbsp;&nbsp;
				  	 ...
				  	 <c:forEach begin="${pvo.beginBlock }" end="${pvo.endBlock }" step="1" var="k">
						   	<c:choose>
									...
									<c:otherwise>
										<span style="color: tomato; padding: 5px;">
											<a class="btn" href="${pageContext.request.contextPath}/MyController?cmd=master&cPage=${k}">${k}</</a>
										</span>
									</c:otherwise>
								</c:choose>
					   </c:forEach>
						...
						<c:choose>
							...
							<c:otherwise>
								<span style="color: tomato; padding: 5px; border: 1px solid tomato">
									<a class="btn" href="${pageContext.request.contextPath}/MyController?cmd=boardlist&cPage=${pvo.beginBlock+pvo.pagePerBlock}">다음으로</a>
								</span>
							</c:otherwise>
						</c:choose>
					</td>
